...
export default function YouTubeInput({ onUrlSubmit }: YouTubeInputProps) {
  ...
  return (
    <form
      ...
      className="w-full p-4 md:p-6 bg-gray-800 bg-opacity-60 backdrop-blur-md rounded-xl shadow-2xl transition-all duration-300 ease-in-out"
    >
      ...
      {error && (
        <p className="text-red-400 text-sm font-medium mt-3 text-center sm:text-left">
          {error}
        </p>
      )}
    </form>
