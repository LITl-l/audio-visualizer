...
describe('getYouTubeVideoId', () => {
  ...
  it('should return video ID from URL with extra query parameters', () => {
    expect(getYouTubeVideoId('https://www.youtube.com/watch?v=dQw4w9WgXcQ&feature=youtu.be&t=42s')).toBe('dQw4w9WgXcQ');
  });
  ...
  it('should return null for completely invalid URL', () => {
    expect(getYouTubeVideoId('https://www.example.com/watch?v=dQw4w9WgXcQ')).toBe(null);
  });
  
  it('should return null for a URL that looks like youtube but is not', () => {
    expect(getYouTubeVideoId('https://www.notyoutube.com/watch?v=dQw4w9WgXcQ')).toBe(null);
  });
  ...
  it('should handle URLs without http/https', () => {
    expect(getYouTubeVideoId('www.youtube.com/watch?v=dQw4w9WgXcQ')).toBe('dQw4w9WgXcQ');
  ...
  it('should return null for invalid youtube channel URL that happens to have 11 chars', () => {
    expect(getYouTubeVideoId('https://www.youtube.com/channel/UC-lHJZR3Gqxm24_Vd_AJ5Yw')).toBe(null);
